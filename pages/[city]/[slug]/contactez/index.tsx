...
export default function Contactez({ store }: any) {
  ...
  if (store) {
    paths = [
      ...
      {
        href: `/${store.city}/${store.slug}/contactez-nouz`,
        breadcrumb: `contactez-nouz`
      },
    ]
  }
  ...
  return (
    <main className="overflow-hidden min-h-[90.3vh]  px-4 sm:px-6 lg:px-8">
      <div className="max-w-[92rem] mt-12 mx-auto ">
        <Breadcrumb store={store} paths={paths} />
      </div>
      <div className="bg-warm-gray-50">
        <div className="py-24 lg:py-32 max-w-[92rem] mx-auto">
          <div className="relative z-10 max-w-7xl pl-4 lg:pl-0 pr-8 sm:px-6">
